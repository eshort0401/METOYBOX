...
A collection of meteorological (and other) toy/analytic models. Some pedagogic content. My goal here is to try to excite people about maths as much as meteorology. The dream would be to build a site with heaps of models to complement textbooks like Vallis (2007). I think having interactive figures and code alongside the maths could be helpful.
